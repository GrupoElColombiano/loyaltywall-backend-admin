...
const paywall_data_schema_1 = require("./entities/paywall-data.schema");
let PaywallService = exports.PaywallService = class PaywallService {
    constructor(siteRpo, eventsRpo, pointsValueRepo, eventsPointsSite, entityManager, paywallModel, planModel) {
    ...
    async addMetadataPaywall(obj) {
    }
    async addMetadataPaywallMongo(obj) {
        console.log(...oo_oo(`1168959452_179_4_179_78_4`, " ================ addMetadataPaywallMongo ================="));
        ...
        console.log(...oo_oo(`1168959452_193_4_193_42_4`, " EMPIEZA ", paywallEntry));
        if (!paywallEntry) {
            ...
            console.log(...oo_oo(`1168959452_212_6_212_48_4`, " EL USER TYPE ES ", userType));
            console.log(...oo_oo(`1168959452_213_8_213_65_4`, " EL USER TYPE ES registrado:: ", registrado));
            if (userType != anonimo) {
                this.registerPointsEvent({ userId: uniqueId, nameSite: site, eventoId: 2 });
            }
        }
        else {
            console.log(...oo_oo(`1168959452_220_6_220_49_4`, " EL REGISTRO ES ESTE VE:::: "));
            ...
            console.log(...oo_oo(`1168959452_248_6_248_70_4`, 'paywallEntryCurrentMeta ', paywallEntryCurrentMeta));
            if (paywallEntryCurrentMeta.length == 0) {
                const newData = new paywall_data_schema_1.PaywallData();
                ...
                paywallEntry.paywallData.push(newData);
                await paywallEntry.save();
                console.log(...oo_oo(`1168959452_263_8_263_50_4`, " EL USER TYPE ES ", userType));
                console.log(...oo_oo(`1168959452_264_8_264_65_4`, " EL USER TYPE ES registrado:: ", registrado));
                if (userType != anonimo) {
                    this.registerPointsEvent({ userId: uniqueId, nameSite: site, eventoId: 2 });
                }
            }
            else {
                console.log(...oo_oo(`1168959452_273_8_275_9_4`, 'El cromaId ya existe en el arreglo o se ha alcanzado el límite.'));
                permissions = {
                    template: '',
                    style: '',
                    permissiones: 1,
    ...
    async getMetadataPaywall(uniqueId, userType, site, isAccessibleForFree, amount, category, duration, unlimited, allProduct, identifier) {
        ...
        const timestampSemanaAnteriorMenosUnDia = timestampSemanaAnterior + 1 * 24 * 60 * 60 * 1000;
        const desdeFecha = timestampSemanaAnteriorMenosUnDia;
        const hastaFecha = timestampHasta;
        console.log(...oo_oo(`1168959452_344_4_344_48_4`, '======= getMetadata ======== '));
        console.log(...oo_oo(`1168959452_345_4_345_48_4`, '======= getMetadata ======== '));
        console.log(...oo_oo(`1168959452_346_4_346_48_4`, '======= getMetadata ======== '));
        console.log(...oo_oo(`1168959452_347_4_347_41_4`, 'uniqueId::: ', uniqueId));
        console.log(...oo_oo(`1168959452_348_4_348_41_4`, 'usertype::: ', userType));
        console.log(...oo_oo(`1168959452_349_4_349_33_4`, 'site::: ', site));
        console.log(...oo_oo(`1168959452_350_4_350_49_4`, ' durationParam ', durationParam));
        console.log(...oo_oo(`1168959452_351_4_351_69_4`, ' timestampSemanaAnterior ', timestampSemanaAnterior));
        console.log(...oo_oo(`1168959452_352_4_352_41_4`, 'category::: ', category));
        console.log(...oo_oo(`1168959452_353_4_353_37_4`, 'amount::: ', amount));
        console.log(...oo_oo(`1168959452_354_4_354_45_4`, 'allProduct::: ', allProduct));
        console.log(...oo_oo(`1168959452_355_4_355_48_4`, ' identifier:::  ', identifier));
        var avalaible = 0;
        ...
        console.log(...oo_oo(`1168959452_391_4_391_78_4`, ' ======>>> paywallEntryCurrent <<<<===', paywallEntryCurrent));
        if (paywallEntryCurrent) {
            const metaLastWeek = paywallEntryCurrent;
            console.log(...oo_oo(`1168959452_395_6_395_48_4`, 'metaLastWeek ', metaLastWeek));
            const categoryIsAccesibleFreeCiclica = metaLastWeek.filter((element) => element.paywallData.category === category).length;
            const categoryIsAccesibleSubscribedCiclica = metaLastWeek.filter((element) => element.paywallData.category === category).length;
            console.log(...oo_oo(`1168959452_404_6_404_62_4`, 'isAccessibleForFree ', isAccessibleForFree));
            if (String(isAccessibleForFree).toLowerCase() == 'true') {
                console.log(...oo_oo(`1168959452_406_8_409_9_4`, '===== categoryIsAccesibleFreeCiclica ===== ', categoryIsAccesibleFreeCiclica));
                avalaible = amount - categoryIsAccesibleFreeCiclica;
                console.log(...oo_oo(`1168959452_414_8_414_47_4`, '1) avalaible ', avalaible));
                console.log(...oo_oo(`1168959452_415_8_415_61_4`, '2) categoryIsAccesible.amount ', amount));
                if (avalaible > 0) {
                }
            }
            console.log(...oo_oo(`1168959452_421_6_421_62_4`, 'isAccessibleForFree ', isAccessibleForFree));
            if (String(isAccessibleForFree).toLowerCase() === 'false') {
                console.log(...oo_oo(`1168959452_423_8_426_9_4`, '===== categoryIsAccesibleSubscribedCiclica ===== ', categoryIsAccesibleSubscribedCiclica));
                avalaible = amount - categoryIsAccesibleSubscribedCiclica;
                console.log(...oo_oo(`1168959452_431_8_431_47_4`, '3) avalaible ', avalaible));
                console.log(...oo_oo(`1168959452_432_8_432_61_4`, '4) categoryIsAccesible.amount ', amount));
                if (avalaible > 0) {
                }
            }
            console.log(...oo_oo(`1168959452_437_6_437_38_4`, 'ENTRO POR AQUIII '));
        }
        else {
            console.log(...oo_oo(`1168959452_440_6_440_45_4`, 'ENTRO POR ESTA BNIENNN  '));
        }
        console.log(...oo_oo(`1168959452_443_4_443_78_4`, ' ======>>> paywallEntryCurrent <<<<===', paywallEntryCurrent));
        permissions.avalaible = avalaible;
        permissions.unlimited = unlimited;
        return permissions;
    }
    async addPlanPaywallMongo(obj) {
        console.log(...oo_oo(`1168959452_511_4_511_44_4`, " DIOS ES BUENO AMEN ", obj));
        let response = { permissiones: 0, plan: {} };
        const { plan, nameSite, usertype } = obj;
        console.log(...oo_oo(`1168959452_515_4_515_41_4`, 'nameSite::: ', nameSite));
        console.log(...oo_oo(`1168959452_516_4_516_41_4`, 'usertype::: ', usertype));
        console.log(...oo_oo(`1168959452_517_4_517_60_4`, 'PLAN ACTUAL ASI QUE PILAS PUES ::: ', plan));
        const planEntry = await this.planModel.findOne({ nameSite, usertype });
        console.log(...oo_oo(`1168959452_519_4_519_43_4`, 'planEntry::: ', planEntry));
        if (!planEntry) {
            ...
            console.log(...oo_oo(`1168959452_530_6_530_52_4`, 'El plan ya existe en el arreglo'));
            response = {
                permissiones: 1,
                plan: planEntry,
            };
    ...
    async registerPointsEvent(obj) {
        ...
        if (eventoId == 6) {
            const pointsEventCurrent = await this.entityManager
                ...
                .from(points_events_entity_1.PointsEvents, 'c')
                .where('c.siteIdSite IN (SELECT "idSite" FROM Site WHERE name = :siteName)', { siteName: nameSite })
                .andWhere('c.eventIdEvent = :eventId', { eventId: eventoId })
        ...
        console.log(...oo_oo(`1168959452_578_6_578_47_4`, " eventoSitio ", eventoSitio));
        if (eventoSitio) {
            ...
            console.log(...oo_oo(`1168959452_590_8_590_63_4`, " statusRegisterUser ", statusRegisterUser));
...
exports.PaywallService = PaywallService = __decorate([
    ...
    __param(5, (0, mongoose_1.InjectModel)(paywall_schema_1.Paywall.name)),
    __param(6, (0, mongoose_1.InjectModel)(plan_schema_1.Plan.name)),
