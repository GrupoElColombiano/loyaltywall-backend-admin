...
const access_modules_service_1 = require("../access-modules/access-modules.service");
let ProductService = exports.ProductService = class ProductService {
    constructor(productRepository, categoryRepository, registerlogService, accessModulesService) {
        this.productRepository = productRepository;
        this.categoryRepository = categoryRepository;
        this.registerlogService = registerlogService;
        this.accessModulesService = accessModulesService;
    }
    async findAllWithPaginationAndFilter(query) {
    ...
    async findByFilter(query) {
        ...
        console.log(...oo_oo(`391436027_112_4_112_31_4`, 'query', query));
        try {
            ...
            console.log(...oo_oo(`391436027_157_6_157_39_4`, 'products', products));
            const category = await queryBuilder2.getMany();
            console.log(...oo_oo(`391436027_159_6_159_39_4`, 'category', category));
            return {
                products,
                category,
            };
...
exports.ProductService = ProductService = __decorate([
    ...
    __metadata("design:paramtypes", [typeorm_2.Repository,
        ...
        access_modules_service_1.AccessModulesService])
], ProductService);
;
function oo_cm() { try {
