...
let KeycloakController = exports.KeycloakController = class KeycloakController {
    ...
    async loginTokenFinalUsers(credentials) {
        console.log(...oo_oo(`3882140081_39_4_39_43_4`, 'credentials', credentials));
    ...
    async findAllWithPaginationAndFilterFinalUsers(tokenAccess, query) {
        console.log(...oo_oo(`3882140081_50_4_50_47_4`, 'ingreso al controller', query));
        return await this.keycloakService.findAllWithPaginationAndFilterFinalUsers(tokenAccess, query);
    }
    async loginToken(credentials) {
        console.log(...oo_oo(`3882140081_67_4_67_43_4`, 'credentials', credentials));
    ...
    async findAllPagination(tokenAccess, query) {
        console.log(...oo_oo(`3882140081_116_4_116_47_4`, 'ingreso al controller', query));
        return await this.keycloakService.findAllWithPaginationAndFilter(tokenAccess, query);
    }
    async listUsers(tokenAccess) {
        console.log(...oo_oo(`3882140081_132_4_132_37_4`, 'token', tokenAccess));
        return await this.keycloakService.listUsers(tokenAccess);
    }
    async findAllPaginationRoles(tokenAccess, query) {
        return await this.keycloakService.findAllWithPaginationAndFilterRoles(tokenAccess, query);
    }
    async listRoles(tokenAccess) {
        console.log(...oo_oo(`3882140081_164_4_164_37_4`, 'token', tokenAccess));
    ...
    async listRolesByUser(tokenAccess, userId, req) {
        ...
        console.log(...oo_oo(`3882140081_262_4_262_111_4`, "🚗 roles by userId executed 🚗", JSON.stringify({ userId, clientIp, userAgent, tokenAccess })));
...
__decorate([
    ...
    (0, common_1.Post)('final-user/token'),
...
], KeycloakController.prototype, "loginTokenFinalUsers", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    (0, common_1.Get)('final-users/filter-pagination'),
    (0, swagger_1.ApiOperation)({ summary: 'Get users with pagination and filter' }),
    ...
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "findAllWithPaginationAndFilterFinalUsers", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "loginToken", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "refreshToken", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    ...
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "createUser", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    (0, common_1.Get)('users/filter-pagination'),
    (0, swagger_1.ApiOperation)({ summary: 'Get users with pagination and filter' }),
    openapi.ApiResponse({ status: 200, type: [Object] }),
    __param(0, (0, common_1.Headers)('Authorization')),
    __param(1, (0, common_1.Query)(new common_1.ValidationPipe({ transform: true }))),
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "findAllPagination", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
...
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    (0, common_1.Get)('roles/filter-pagination'),
    (0, swagger_1.ApiOperation)({ summary: 'Get roles with pagination and filter' }),
    openapi.ApiResponse({ status: 200, type: [Object] }),
    __param(0, (0, common_1.Headers)('Authorization')),
    __param(1, (0, common_1.Query)(new common_1.ValidationPipe({ transform: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "findAllPaginationRoles", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "listRoles", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    (0, common_1.Post)('paywallModule'),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new paywall module' }),
    openapi.ApiResponse({ status: 201, type: Object }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "createPaywallModule", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    (0, common_1.Get)('paywallModule'),
    (0, swagger_1.ApiOperation)({ summary: 'List all paywall modules' }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "listPaywallModule", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
...
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    (0, common_1.Get)('users/:role/list'),
    (0, swagger_1.ApiOperation)({ summary: 'Find a user by role' }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, common_1.Headers)('Authorization')),
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], KeycloakController.prototype, "listUserByRol", null);
__decorate([
    (0, nest_keycloak_connect_1.Public)(true),
    (0, common_1.Get)('roles/:userId/list'),
    (0, swagger_1.ApiOperation)({ summary: 'Find roles from user id' }),
    openapi.ApiResponse({ status: 200, type: Object }),
    __param(0, (0, common_1.Headers)('Authorization')),
